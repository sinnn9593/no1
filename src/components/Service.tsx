      ...
      `}
        ...
        <ul className="text-lg list-disc pl-6 mb-6 space-y-10 mb-15">
          ...
          <li>
            ...
            また、Pygameのイベントハンドリング機能により、プレイヤーからのキー入力（矢印キーによる移動）をリアルタイムに取得し、即座にPac-Manの動作に反映。これにより、「イベント駆動型プログラム」としての構造を持ちながら、ゲームの流れをシンプルに保つ工夫をしています。
          </li>

          <li>
            <strong>サウンド管理:</strong>
            <br />
            ゲーム中の効果音（エサを食べたとき、ゴーストにやられたとき、クリア時のファンファーレなど）は、Pygame.mixerモジュールで制御。特に、複数サウンドの同時再生や、BGMと効果音のミキシングには、Pygame.mixerを活用しています。
