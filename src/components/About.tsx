      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="my-12 bg-white p-8 rounded-xl shadow-lg shadow-gray-400/30">
          ...
          <p className="text-lg text-gray-700 leading-relaxed space-y-4">
            私は広く浅く多くの技術に触れてきました。主に以下の分野で経験があります。<br /><br />
            <div>1 :  競技プログラミング
            AtCoder、Codeforcesなどで活動しています。特にアルゴリズム、データ構造、そして計算量の見積もりと削減に少しだけ強みがあります。<br /></div>
            <div>2 :  ゲーム開発 snake
            gameやブロック崩しなどのゲームのc++での開発経験あり。(ライブラリー :
            SDL2,設計思想 : オブジェクト指向)<br /></div>
             <div>3 :  Web開発 :
            Reactを用いた3Dオブジェクトを含むWebsiteの制作。(jQuery,Bootstrapm、HTML,CSSのみの開発も多少あり)<br /></div>
             <div>4 :  Github活用 このポートフォリオ関連の成果物をGithubで公開。(github
            ActionsでCI/CDも導入) *画像が読み込まれないエラーあり</div>
          </p>
        </div>
        ...
        <div className="my-12 bg-white p-8 rounded-xl shadow-lg shadow-gray-400/30">
          ...
          <p className="text-lg text-gray-700 leading-relaxed space-y-4">
            <div>・ゲストハウス勤務 :
            海外の方との交流を通じて、英語でのコミュニケーション力と多文化理解を向上。これにより、英語の技術ドキュメントを読む力や、グローバルな開発環境での適応力が身についた。(コードを読み理解する力,関数の変数名から機能の推測する力など。また、エンジニアという職業にに対する海外での評価や印象など)</div>
            <div>・工場での勤務 :
            限られた時間で効率的に作業をこなす必要があり、最適な作業フローを考える習慣がついた。これがアルゴリズムの最適化や効率的なコードを書く意識につながっている。</div>
            <div>・ 配達員 :
            配達ルートを考えたり、時間内に効率よく動く必要があるため、リアルタイムで最適な選択する力が身についた。これは、ゲームAIのアルゴリズム設計やデータをもとに動的に判断するプログラミングに応用できる。(Google
            Mapの最短経路や、配達員と店舗と注文者との組み合わせによるマッチング最適化などアルゴリズムが使われていて気づきも多かったです。)</div>
          </p>
        </div>
