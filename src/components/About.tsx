...
const About = () => {
  ...
  About Me
        ...
        <div className="my-12 bg-white p-8 rounded-xl shadow-lg shadow-gray-400/30">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">はじめまして、sinnn9593です</h2>
        ...
        <div className="my-12 bg-white p-8 rounded-xl shadow-lg shadow-gray-400/30">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">開発・スキル</h2>
          <p className="text-lg text-gray-700 leading-relaxed">
            私は広く浅く多くの技術に触れてきました。主に以下の分野で経験があります。
             1 : 競技プログラミング AtCoder、Codeforcesなどで活動しています。特にアルゴリズム、データ構造、そして計算量の見積もりと削減に少しだけ強みがあります。
             2 : ゲーム開発 snake gameやブロック崩しなどのゲームのc++での開発経験あり。(ライブラリー : SDL2,設計思想 : オブジェクト指向)
             3 : Web開発 : Reactを用いた3Dオブジェクトを含むWebsiteの制作。(jQuery,Bootstrapm、HTML,CSSのみの開発も多少あり)
             4 : Github活用 このポートフォリオ関連の成果物をGithubで公開。(Github ActionsでCI/CDも導入) *画像が読み込まれないエラーあり
          </p>
        </div>
        ...
        <div className="my-12 bg-white p-8 rounded-xl shadow-lg shadow-gray-400/30">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
           ・ゲストハウス勤務 : 海外の方との交流を通じて、英語でのコミュニケーション力と多文化理解を向上。これにより、英語の技術ドキュメントを読む力や、グローバルな開発環境での適応力が身についた。(コードを読み理解する力,関数の変数名から機能の推測する力など。また、エンジニアという職業にに対する海外での評価や印象など)
           ・工場での勤務 : 限られた時間で効率的に作業をこなす必要があり、最適な作業フローを考える習慣がついた。これがアルゴリズムの最適化や効率的なコードを書く意識につながっている。
           ・ 配達員 : 配達ルートを考えたり、時間内に効率よく動く必要があるため、リアルタイムで最適な選択する力が身についた。これは、ゲームAIのアルゴリズム設計やデータをもとに動的に判断するプログラミングに応用できる。(Google Mapの最短経路や、配達員と店と注文者との組み合わせによるマッチング最適化などアルゴリズムが使われていて気づきも多かったです。)        </p>
        </div>
